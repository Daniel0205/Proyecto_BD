        ...
        return (
          <div className="prin1">
            ...
            <div className="opciones">
              ...
              <div>
                <button className="butc" onClick={this.modificarDatos}>
                  Modificar Datos
                </button>
                <button className="butc" onClick={this.reportarEstado}>
                  Reportar Estado
                </button>
                <button id="bt1" className="butc" onClick={this.verViajes}>
                  Ver Viajes
                </button>
              </div>
            </div>
          ...
          <div className="prin1">
            ...
            <div className="opciones">
              ...
              <div>
                ...
                <button className="butc" onClick={this.solicitarViaje}>
                  Solicitar Viaje
                </button>
                <button id="bt2" className="butc" onClick={this.verViajes}>
                  Ver Viajes
                </button>
              </div>
            </div>
